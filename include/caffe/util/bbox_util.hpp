...
void GetDetectionResults(const Dtype* det_data, const int num_det,
      const int background_label_id,map<int, LabelBBox>* all_detections);



//GetDetectionResultsÐÂµÄº¯Êý
//template <typename Dtype>
//void GetDetectionResults(const Dtype* det_data, const int num_det,
//	const int background_label_id,
//	map<int, LabelBBox>* all_detections, vector<pair<int, int>>& old2new, bool isMap);
